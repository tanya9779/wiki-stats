...
if __name__ == '__main__':
    ...
    average_redirect = statistics.mean(external_redirection[i] for i in range(total))
    stdev_redirect = statistics.stdev(external_redirection[i] for i in range(total))
    ...
    last_page  = wg.get_id('Список_файловых_систем')
